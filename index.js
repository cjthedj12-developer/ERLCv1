...
const webhookClient = new WebhookClient({ id: '1365319938968912042', token: '1KrdTEI40_q0IYe8i7z6LcRsKPqruVl3kcACUAKBkMLOmG8W5XVdr67d_fj7Vm7QQaUV' });
...
.then(response => {
 ...
 webhookClient.editMessage('1365320503753183283', {
